...
var Registry = map[models.ToolType]ToolExecInfo{
	...
	models.ToolKube: {
		...
		ConfigFiles: []string{".kubespectre.yaml"},
		InstallHint: "brew install ppiankov/tap/kubespectre",
	},
	models.ToolRedis: {
		Binary:      "redisspectre",
		Subcommand:  "audit",
		...
		ConfigFiles: []string{".redisspectre.yaml"},
		InstallHint: "brew install ppiankov/tap/redisspectre",
	},
	models.ToolECR: {
		Binary:      "ecrspectre",
		Subcommand:  "scan",
		JSONFlag:    "--format json",
		EnvVars:     []string{"AWS_PROFILE", "AWS_REGION", "GOOGLE_APPLICATION_CREDENTIALS"},
		ConfigFiles: []string{".ecrspectre.yaml"},
		InstallHint: "brew install ppiankov/tap/ecrspectre",
	},
	models.ToolRDS: {
		Binary:      "rdsspectre",
		Subcommand:  "audit",
	...
	models.ToolSnow: {
		...
		Subcommand:  "audit",
		JSONFlag:    "--format json",
		EnvVars:     []string{"SNOWFLAKE_ACCOUNT", "SNOWFLAKE_USER"},
		ConfigFiles: []string{".snowspectre.yaml"},
		InstallHint: "brew install ppiankov/tap/snowspectre",
	},
	models.ToolCI: {
		Binary:      "cispectre",
		Subcommand:  "scan",
		...
		ConfigFiles: []string{".cispectre.yaml"},
		InstallHint: "brew install ppiankov/tap/cispectre",
	},
	models.ToolLog: {
		Binary:      "logspectre",
		Subcommand:  "scan",
		JSONFlag:    "--format json",
		EnvVars:     []string{"AWS_PROFILE", "GOOGLE_APPLICATION_CREDENTIALS", "AZURE_SUBSCRIPTION_ID"},
		ConfigFiles: []string{".logspectre.yaml"},
		InstallHint: "brew install ppiankov/tap/logspectre",
	},
	models.ToolDNS: {
		Binary:      "dnsspectre",
		Subcommand:  "scan",
		JSONFlag:    "--format json",
		EnvVars:     []string{"AWS_PROFILE", "GOOGLE_APPLICATION_CREDENTIALS", "CLOUDFLARE_API_TOKEN"},
		ConfigFiles: []string{".dnsspectre.yaml"},
		InstallHint: "brew install ppiankov/tap/dnsspectre",
	},
	models.ToolElastic: {
		Binary:      "elasticspectre",
		Subcommand:  "audit",
		JSONFlag:    "--format json",
		EnvVars:     nil,
		ConfigFiles: []string{".elasticspectre.yaml"},
		InstallHint: "brew install ppiankov/tap/elasticspectre",
	},
	models.ToolAI: {
		Binary:      "aispectre",
		Subcommand:  "scan",
		JSONFlag:    "--format json",
		EnvVars:     []string{"OPENAI_API_KEY", "ANTHROPIC_API_KEY", "AWS_PROFILE", "GOOGLE_APPLICATION_CREDENTIALS", "AZURE_OPENAI_API_KEY"},
		ConfigFiles: []string{".aispectre.yaml"},
		InstallHint: "brew install ppiankov/tap/aispectre",
	},
}
